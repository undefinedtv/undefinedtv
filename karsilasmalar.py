...
def main():
    try:
        ...
        for channel in channels:
            ...
            full_url = f'{base_url}{cid}.m3u8|Referer="{active_domain}"&User-Agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36"
